...
def get_args():
    ...
    parser.add_argument('--beta', action='store_true', help='flag for beta')
    parser.add_argument('--normalize', action='store_true', help='flag for beta')
    parser.add_argument('--cam-thr', type=float, default=0.1, help='cam threshold value')
    parser.add_argument('--grad-thr', type=float, default=0.2, help='cam threshold value')
